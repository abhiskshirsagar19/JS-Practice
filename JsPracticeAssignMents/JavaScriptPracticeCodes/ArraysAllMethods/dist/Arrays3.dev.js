...
var cards = ["ICICI", "RBL", "HDFC", "BOI", "UBI"];
...
var paymentMode = ["Card Payment", "UPI", "Net Banking", "QR Code", "Cash"];
var pm_1 = paymentMode.slice(1, 3); // UPI Net Banking

var pm = paymentMode.slice(-3, -2); //Net Banking
...
function checkPayment(payment) {
  if (payment == "Card t" || payment == "UI" || payment == "Net Bking" || payment == "QCode" || payment == "Ch") {
    //(payment == "Card Payment" || payment == "UPI" || payment == "Net Banking" || payment == "QR Code" || payment == "Cash") true
    return true;
  } else {
...
;
var result = paymentMode.some(checkPayment);
console.log(result);
/*The sort() sorts the elements of an array.
The sort() overwrites the original array.
The sort() sorts the elements as strings in alphabetical and ascending order.*/

var sortResult = paymentMode.sort();
...
var dummyPaymentarr = paymentMode.valueOf();
...
var mewPaymentmodes = paymentMode["with"](0, "New Cash Payment");
